...
public class CallToAction {
	...
	@Test(dataProvider="ctaData")
	public void callToAction(String username,String password,String cta,String heading,String message,String button) throws Exception
	{
		...
		driver.findElement(By.xpath("//button[@type='button' and @icon='edit']")).click();
		...
		//delete cta
//		if (driver.findElement(By.xpath("//div[@class='cq-droptarget cq-subdroptarget cq-Overlay-subdroptarget' and @style='top: 0px; left: 12px; width: 1152px; height: 211px;']")).isDisplayed()) {
...
//		else
		...
		driver.findElement(By.xpath("/html/body/coral-dialog/div[2]/coral-dialog-content/coral-search/input")).sendKeys(cta);
		...
		Thread.sleep(2000);
		driver.findElement(By.name("./heading")).sendKeys(heading);
		driver.findElement(By.name("./message")).sendKeys(message);
		driver.findElement(By.name("./callToAction")).sendKeys(button);
    ...
    {
        ExcelDataConfig config=new ExcelDataConfig("C:\\Users\\vijayalakshmi B\\git\\Datadrivenframework\\TestData\\ctaButton.xlsx");
